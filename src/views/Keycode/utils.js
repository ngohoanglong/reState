...
export function toggleTable() {
  ...
  document.querySelector(".table-toggle-button").textContent = hidden
    ? "Table"
    : "⬅";
}
export const createKeycodeview = (body, mobileInputDiv, canvas) => {
  ...
  body.onkeydown = function (e) {
    ...
    if (e.key != null && e.key === "Unidentified") {
      newKeyText =
        '<a href="https://developer.mozilla.org/en-US/docs/Web/API/KeyboardEvent/key/Key_Values#Special_values" target="_blank" rel="noopener">Unidentified</a>';
    } else if (e.key === " ") {
    ...
    if (e.location == null) {
      ...
      newLocationFriendlyText =
        '<a href="https://developer.mozilla.org/en-US/docs/Web/API/KeyboardEvent/location" target="_blank" rel="noopener">Other</a>';
    } else {
    ...
    if (e.code != null && e.code === "Unidentified") {
      newCodeText =
        '<a href="https://w3c.github.io/uievents-code/#table-key-code-special" target="_blank" rel="noopener">Unidentified</a>';
    } else {
      newCodeText = e.code || "";
    }
    ...
    document.querySelector(
      ".item-key .main-description"
    ).innerHTML = newKeyText;
    document.querySelector(
      ".item-location .main-description"
    ).innerHTML = newLocationText;
    document.querySelector(".item-which .main-description").innerHTML =
      e.which || "";
    document.querySelector(
      ".item-code .main-description"
    ).innerHTML = newCodeText;
  };
  ...
  function onCardClick() {
    const card = this;
    let description = card.querySelector(".card-main .main-description")
      .innerHTML;
