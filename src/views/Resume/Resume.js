          ...
          <div className="side-menu">
            ...
            <a href="#">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                ...
                <path
                  d="M499.7 157.8A125.9 125.9 0 00276.9 212a8.4 8.4 0 0010.2 9.7L495 171a8.5 8.5 0 004.6-13.3z"
                  fill="#a4d64d"
                />
                <path
                ...
                <path
                  d="M299.2 239.2a29.3 29.3 0 01-24.5-45.4 29.3 29.3 0 1040.7 40.6c-4.7 3-10.2 4.8-16.2 4.8z"
                  fill="#928d86"
                />
                <circle cx={316} cy={256} r="29.3" fill="#a4a09a" />
                <path
                  d="M324.4 281.1a29.3 29.3 0 01-17.1-53.1 29.4 29.4 0 1025.8 51.8c-2.8.9-5.7 1.3-8.7 1.3z"
                  fill="#928d86"
                />
            ...
            <a href="#">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                ...
                />
                <path
                  d="M130.2 107.4H175a39.8 39.8 0 110 79.7h-44.8a8.1 8.1 0 01-8.1-8.2v-63.4c0-4.5 3.6-8.1 8-8.1z"
                  fill="#f8b40e"
                />
                <path
                  d="M175 170.8h-53v8.1c0 4.5 3.7 8.1 8.2 8.1H175a40 40 0 0039-48 39.8 39.8 0 01-39 31.8z"
                  fill="#dd9b0a"
                />
                ...
                <path
                  d="M99.5 473.6C71.6 473.6 49 451 49 423h15.7a35 35 0 0069.8 0h15.7c0 28-22.7 50.6-50.6 50.6z"
                  fill="#1d2c30"
                />
                <path
                  d="M343.6 423A78.8 78.8 0 01381 274.7c42 0 125 22.2 131 135.1.4 7.2-5.3 13.2-12.4 13.2h-156z"
                  fill="#f8b40e"
                />
                <path
                  d="M327.6 365.6a78.9 78.9 0 0179-79c12.4 0 28.6 2 45.2 7.8a138.7 138.7 0 00-70.8-19.7A78.9 78.9 0 00343.6 423h8.8a78.7 78.7 0 01-24.8-57.4z"
                  fill="#dd9b0a"
                />
                ...
                />
                <path
                  d="M415.1 473.6c-27.9 0-50.6-22.7-50.6-50.6h15.7a35 35 0 0069.8 0h15.8c0 28-22.8 50.6-50.7 50.6z"
                  fill="#1d2c30"
                />
                <path
            ...
            <a href="#">
              <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                ...
                />
                <path
                  d="M428 162h-27l-5 2-15 22c-3 4-9 3-10-2l-5-15 2-2 16-23 5-2h28c2 0 4-1 5-3l10 14c3 4 0 9-4 9z"
                  fill="#fb8801"
                />
                ...
                <path
                  d="M136 4c-6 11-18 33-38 41-3 1-3 5 0 7 20 8 32 29 38 41 1 2 4 2 6 0 5-12 18-33 37-41 3-2 3-6 0-7-19-8-32-30-37-41-2-2-5-2-6 0z"
                  fill="#fe9901"
                />
                <path
                  d="M179 52c-19 8-32 29-37 41-2 2-5 2-6 0l-9-15a87 87 0 0139-41l13 8c3 1 3 5 0 7z"
                  fill="#fb8801"
                />
                <path
                  d="M345 426c-4 9-14 26-30 33-2 1-2 4 0 5 16 7 26 24 30 33 1 2 4 2 5 0 5-9 15-26 31-33 2-1 2-4 0-5-16-7-26-24-31-33-1-2-4-2-5 0z"
                  fill="#fe9901"
                />
                <path
                ...
                <path
                  d="M251 94a23 23 0 11-47 0c4 2 8 4 13 4 13 0 23-10 23-23 7 4 11 11 11 19z"
                  fill="#26a6fe"
                />
                <path
                  d="M164 136l217 217c3 3 3 8 0 11l-21 21c-3 3-8 3-11 0L132 168c-3-3-3-8 0-11l21-21c3-3 8-3 11 0z"
                  fill="#f3eae6"
                />
                <path
                  d="M381 364l-21 20c-3 4-8 4-11 0l-15-14c4 3 9 3 12 0l20-20c3-4 3-9 0-12l15 15c3 3 3 8 0 11z"
                  fill="#e1d3ce"
                />
              </svg>
              Dance
      ...
      <div className="main">
        <div className="main-container">
          <div className="profile overflow-hidden">
            ...
            />
            <div className="profile-menu overflow-auto justify-start z-10">
              {[
                "basics",
                "work",
                "volunteer",
                ...
                i === 0 ? (
                  ...
                  <a key={item} className={"profile-menu-link"}>
                    {item}
                  </a>
                )
              )}
